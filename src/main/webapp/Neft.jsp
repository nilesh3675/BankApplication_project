         ...
         <div class="parent">
          <form action="NeftController">
              <div class="form-group">
                      <label class="control-label col-sm-7" for="text"><i class="fa-solid fa-file-invoice"></i> Account Number :</label>
                  <div class="col-sm-9">
                      <input type="text" class="form-control" name="toAcNo" required placeholder=" Account Number :"><br>
                  </div>
              </div>
              <div class="formgroup">
                      <label class="control-label col-sm-7" for="amount"><i class="fa-solid fa-file-invoice"></i>Ifsc Code:</label>
                  <div class="col-sm-9">
                      <input type="number" class="form-control" name="ifsc" required placeholder="Ifsc Code"><br>
                  </div>
              </div>
              <div class="form-group">
                  <label class="control-label col-sm-7"><i class="fa-solid fa-building-columns"></i> Branch:</label>
                  <div class="col-sm-9">
            ...
            <div class="form-group">
             ...
             <%
	 String str=(String)session.getAttribute("neftError");
	%>
	<p style='color: red'>
    <%
